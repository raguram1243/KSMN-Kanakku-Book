        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="font-semibold text-gray-900">{entry.entry_code}</div>
            </div>
            <div>
              <div className="text-sm text-gray-600">Date & Time</div>
              <div className="font-medium text-gray-900">{formatDateTime(entry.created_at)}</div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 pt-4">
            <div className="text-sm font-medium text-gray-700 mb-3">Financial Summary</div>
            <div className="space-y-2">
              <div className="flex justify-between">
                <span className="text-gray-600">Total Amount:</span>
                <span className="font-semibold text-gray-900">{formatCurrency(entry.total_amount)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Paid Amount:</span>
                <span className="font-medium text-gray-900">{formatCurrency(entry.paid_amount)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Balance:</span>
                <span className={`font-bold ${Number(entry.balance) > 0 ? 'text-red-600' : 'text-green-600'}`}>
